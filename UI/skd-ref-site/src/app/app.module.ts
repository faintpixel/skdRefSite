...
import { faBackward, faForward, faPause, faPlay, faStop, faInfoCircle, faQuestionCircle, faSun, faMoon, faExclamationCircle, faTable, faPalette, faExchangeAlt, faSort } from '@fortawesome/free-solid-svg-icons';
...
library.add(faBackward, faForward, faPause, faPlay, faStop, faInfoCircle, faQuestionCircle, faSun, faMoon, faExclamationCircle, faTable, faPalette, faExchangeAlt, faSort);
